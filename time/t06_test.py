...
dense5 = Dense(3, activation='relu')(dense5)
# second input model
visible2 = Input(shape=(n_steps,))
dense2 = Dense(1000, activation='relu')(visible2)
dense6 = Dense(120, activation='tanh')(dense2)
dense7 = Dense(30,activation='relu')(dense6)
dense8 = Dense(500)(dense7)
# merge input models
merge = concatenate([dense5, dense8])
merge1 = Dense(20)(merge)
merge2 = Dense(400, activation='relu')(merge1)
merge3 = Dense(50)(merge2)
output = Dense(1)(merge3)
